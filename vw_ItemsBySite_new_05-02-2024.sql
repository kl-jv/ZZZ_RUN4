...
/****** Object:  View [dbo].[vw_ItemsBySite_new_05-02-2024]    Script Date: 19/02/2024 10:05:41 ******/
SET ANSI_NULLS ON
GO
...
GO
 ...
 -- ALTER VIEW [dbo].[vw_ItemsBySite_new_05-02-2024] AS
				...
				(
					...
					FROM
						(
							...
							WHERE
								bom.DB_DATA_FIN_VAL >= CONVERT(INT,GETDATE())
								AND kps.SupplySource IN ('50')												--10;"Not Applicable (default)";20;"Job Shop";40;"Purchase";50;"Subcontract";60;"Distribution"|*/
