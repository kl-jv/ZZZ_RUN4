...
/****** Object:  View [dbo].[vw_ItemsBySite_new_05-02-2024]    Script Date: 05/02/2024 07:43:00 ******/
SET ANSI_NULLS ON
GO
...
--	, map.KpraktorPlanner
	...
	, map.LN_Employee_Planner								/*Ordering - Planner (tcibd250.cplb) - Reference to tccom001 Employees (HYVA) | FALSE | null | 9 | |*/
...
--	,CAST(NULL AS VARCHAR(9)) AS Buyer						/*Purchase - Buyer (tdipu081.buyr)   - References tccom001 Employees | FALSE | null | 9 | |*/
	...
	, mab.LN_Employee_Buyer AS LN_buyer						/*Purchase - Buyer (tdipu081.buyr)   - References tccom001 Employees | FALSE | null | 9 | |*/
