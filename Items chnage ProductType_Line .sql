...
/****** Object:  View [dbo].[vw_Items_test]    Script Date: 20/12/2023 11:57:12 ******/
SET ANSI_NULLS ON
GO
...
-- CREATE  VIEW [dbo].[vw_Items_test] AS 
...
/*  KL : 16-02-2024 When PorductLine is NULL then ----  */ 	
...
---	,CAST(NULL AS VARCHAR(3)) AS SelectionCode											/*Selection Code (tcibd001.csel)   - Reference to tcmcs022 Selection Codes | FALSE | null | 3 | 3 | |*/
	...
	,CAST(prt.ProductType AS VARCHAR(3)) AS SelectionCode

	,CAST(plt.ProductType AS VARCHAR(3)) AS SelectionCode_new_table
